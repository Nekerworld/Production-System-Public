...
# 학습 루프가 끝난 후
# 최종 모델 저장
model.save('models/final_model.keras', save_format='keras')
print("최종 모델이 models/final_model.keras에 저장되었습니다.")
...
def load_model_and_scaler():
    """모델과 전역 스케일러를 로드"""
    model = tf.keras.models.load_model('models/prediction_model.keras', compile=True)
